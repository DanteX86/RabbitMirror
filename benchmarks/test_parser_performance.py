...
class TestParserPerformance:
    ...
    def test_parse_error_handling_performance(self):
        ...
        error_conditions = [
            ...
            ('invalid_timestamps', lambda: self._create_invalid_timestamps(num_entries)),
        ...
        try:
            ...
            results = {
                'sequential_parsing': {
                    ...
                    'total_entries': sum(len(r.get('entries', [])) if isinstance(r, dict) else len(r) for r in sequential_results)
                },
                'concurrent_parsing': {
                    ...
                    'files_processed': len(test_files),
                    'total_entries': sum(len(r.get('entries', [])) if isinstance(r, dict) else len(r) for r in concurrent_results),
    ...
    def _create_malformed_html(self, num_entries):
        ...
        with os.fdopen(fd, 'w') as f:
            ...
            for i in range(num_entries):
                ...
                if i % 10 == 0:
                    f.write(f'<div class="content-cell"><a href="bad_url">Title {i}</a>\n')
                elif i % 15 == 0:
                    f.write(f'<div><a href="url">Title {i}</a><div>Bad timestamp</div>\n')
                else:
                    f.write(f'<div class="content-cell"><a href="url">Title {i}</a><div class="mdl-typography--caption">Jan 1, 2023</div></div>\n')
    ...
    def _create_invalid_timestamps(self, num_entries):
        ...
        with os.fdopen(fd, 'w') as f:
            ...
            for i in range(num_entries):
                ...
                f.write(f'<div class="content-cell"><a href="url">Title {i}</a><div class="mdl-typography--caption">{timestamp}</div></div>\n')
    ...
    def _create_missing_fields(self, num_entries):
        ...
        with os.fdopen(fd, 'w') as f:
            ...
            for i in range(num_entries):
                if i % 3 == 0:
                    # Missing title
                    f.write(f'<div class="content-cell"><a href="url"></a><div class="mdl-typography--caption">Jan 1, 2023</div></div>\n')
                elif i % 5 == 0:
                    # Missing URL
                    f.write(f'<div class="content-cell"><a>Title {i}</a><div class="mdl-typography--caption">Jan 1, 2023</div></div>\n')
                elif i % 7 == 0:
                    # Missing timestamp
                    f.write(f'<div class="content-cell"><a href="url">Title {i}</a></div>\n')
                else:
                    # Valid entry
                    f.write(f'<div class="content-cell"><a href="url">Title {i}</a><div class="mdl-typography--caption">Jan 1, 2023</div></div>\n')
