...
class TestReportGenerator:
    ...
    def test_generate_report_basic(self, temp_template_dir, sample_report_data, tmp_path):
    ...
    def test_generate_report_with_metadata(self, temp_template_dir, sample_report_data, tmp_path):
        """Test that generated_at metadata is added to report data."""
        report_gen = ReportGenerator(template_dir=str(temp_template_dir))
        output_path = tmp_path / "test_report.html"
        
        # Store original data to verify it's not modified
        original_data = sample_report_data.copy()
    ...
    def test_generate_report_output_directory_creation(self, temp_template_dir, sample_report_data, tmp_path):
    ...
    def test_unicode_content(self, temp_template_dir, tmp_path):
        ...
        unicode_data = {
            ...
            'entries': [
                ...
                {'title': '中文测试 Japanese テスト', 'timestamp': '2025-07-01T12:00:00'}
            ]
        }
