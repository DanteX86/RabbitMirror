...
class TestProfileSimulator:
    ...
    def test_initialization_with_seed(self):
        ...
        assert simulator.rng.get_state()[1][0] == np.random.RandomState(seed).get_state()[1][0]
    ...
    def test_extract_viewing_patterns(self, sample_profile):
        ...
        required_keys = ['time_dist', 'content_dist', 'interval_dist', 'daily_counts', 'title_patterns']
    ...
    def test_extract_title_patterns(self):
        ...
        test_cases = [
            ...
            ('Complex - Title EP.5 (Info) [Tag]', 
             ['CREATOR - CONTENT', 'SERIES_WITH_EPISODE', 'TITLE_WITH_PARENTHESES', 'TITLE_WITH_BRACKETS'])
        ]
